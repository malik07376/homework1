...
JAZMIN_SETTINGS = {
    ...
    "welcome_icon": "fa fa-cog",
    "copyright": "My Company © 2024",
    "search_model": ["auth.User", "myapp.MyModel"], #replace myapp.MyModel
    "topmenu_links": [
    ...
    "theme": "flatly", #or any other supported theme
    "related_field_lookups": "__all__",
    # Add any other Jazmin settings you need here
}